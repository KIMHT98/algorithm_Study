...
<body>
	...
	<h1>SSAFY 맛집 관리</h1>
	<form method="post"
		action="${root }/res/regist"
		enctype="multipart/form-data">
		<fieldset>
			<legend>맛집 입력</legend>
			<label for="resId">맛집 번호</label>
			<input type="number" id="resId" name="resId"><br><br>
			<label for="resName">맛집 이름</label> 
			<input type="text" id="resName" name="resName"><br><br>
			<label for="address">맛집 주소<br>(지역)</label>
			<input type="text" id="address" name="address"><br><br>
			<label for="signatureMenu">시그니쳐메뉴</label>
			<input type="text" id="signatureMenu" name="signatureMenu"><br><br>
