...
public class EmployeeController {
	...
	// GET /employee/{id}
	@GetMapping("/{id}")
	public EmployeeDto detail(@PathVariable("id")int id) throws SQLException{
	...
	// POST /employee
	@PostMapping("")
	public int insert(@RequestBody EmployeeDto employee) throws SQLException{
	...
	// PUT /employee/{id}
	@PutMapping("/{id}")
	public int update(@PathVariable("id")int id,@RequestBody EmployeeDto employee) throws SQLException {
		employee.setId(id);
